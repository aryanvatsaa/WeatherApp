import { getTemperatureUnit, getWindSpeedUnit, getPrecipitationUnit } from "../lib/utils"
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        {metrics.map((metric, index) => (
          <div key={index} className="glass-card rounded-xl p-4 hover:bg-white/20 transition-all duration-200">
